...
def process_images(input_path, output_path, images_names, suppress_output=True):
...
if __name__ == '__main__':
	...
	for i in range(len(batches)):
		p = multiprocessing.Process(target=process_images, args=(input_path, output_path, batches[i]))
		jobs.append(p)
		p.start()
